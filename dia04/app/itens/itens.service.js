(function () {
    ...
    angular.module("listaComprasApp").service("itensService", itensService);
    ...
    function itensService($http, constantes, helper) {
        ...
        function listarCategorias() {
            return $http
                .get(constantes.URL_BASE + "/categorias")
                .then(function (response) {
                    return response.data;
                })
                .catch(helper.sendError);
        ...
        function cadastrar(_param) {
            return $http
                .post(constantes.URL_BASE + "/itens", _param)
                .then(function (response) {
                    return response.data;
                })
                .catch(helper.sendError);
        ...
        function consultar(_id) {
            return $http
                .get(constantes.URL_BASE + "/itens/" + _id)
                .then(function (response) {
                    return response.data;
                })
                .catch(helper.sendError);
        ...
        function editar(_param) {
            return $http
                .put(constantes.URL_BASE + "/itens/" + _param._id, _param)
                .then(function (response) {
                    return response.data;
                })
                .catch(helper.sendError);
        ...
        function deletar(_id) {
            return $http
                .delete(constantes.URL_BASE + "/itens/" + _id)
                .then(function (response) {
                    return response.data;
                })
                .catch(helper.sendError);
