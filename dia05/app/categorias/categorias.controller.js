(function () {
    ...
    function categoriasController(helper, service, $routeParams) {
        ...
        function iniciar() {
            if ($routeParams.id) {
                return consulta($routeParams.id).then(function (_cat) {
                    vm.categoria = _cat;
                });
            } else {
        ...
        function listarCategorias() {
            return service.listar().then(salvarCategorias);
        ...
        function cadastrar() {
            return service.cadastrar(vm.categoria).then(function (_categoria) {
                tratarResposta("cadastrada", _categoria);
            });
        }

        function editar() {
            return service.editar(vm.categoria).then(function (_categoria) {
